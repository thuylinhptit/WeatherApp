...
Weather todoFromJson(List<int> bytes) => Weather.fromJson(json.decode(utf8.decode(bytes)));

String todoToJson(Weather data) => json.encode(data.toJson());
...
class Weather {
  ...
  factory Weather.fromJson(Map<String, dynamic> json) => Weather(
    consolidatedWeather: List<ConsolidatedWeather>.from(json["consolidated_weather"].map((x) => ConsolidatedWeather.fromJson(x, json["title"]))),
...
class ConsolidatedWeather {
  ...
  factory ConsolidatedWeather.fromJson(Map<String, dynamic> json, String title) => ConsolidatedWeather(
    id: json["id"],
